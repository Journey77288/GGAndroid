...
class LanguageHelper private constructor() {
     ...
     */
    private fun init(context: Application, listener: OnLanguageChangeListener) {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun initialize(context: Application, listener: OnLanguageChangeListener) {
         ...
         */
        @JvmStatic
        fun applyLanguage(context: Context, locale: Locale, restartActivityClazz: Class<out Activity>): Boolean {
        ...
        private fun checkInit() {
            check(::instance.isInitialized) {
                "You have to initialize LanguageHelper.initialize(context,listener) in Application first!!"
            }
        }
