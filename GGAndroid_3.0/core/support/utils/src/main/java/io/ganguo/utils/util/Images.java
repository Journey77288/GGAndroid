...
public class Images {
    ...
    public static File easyCompress(File from, File to, int outSize) {
        Bitmap scaledBitmap = Bitmaps.Companion.uniformScale(from);
        Bitmap rotatedBitmap = Bitmaps.Companion.rotateToNormal(scaledBitmap, from.getAbsolutePath());
        Bitmaps.Companion.compress(rotatedBitmap != null ? rotatedBitmap : scaledBitmap, to, outSize);

        Logger.INSTANCE.tag("compress")
