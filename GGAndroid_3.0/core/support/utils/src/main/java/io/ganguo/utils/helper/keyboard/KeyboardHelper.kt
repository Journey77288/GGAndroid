 ...
 */
class KeyboardHelper internal constructor(activity: ComponentActivity, private var stateListener: KeyboardStateListener) : ViewTreeObserver.OnGlobalLayoutListener, LifecycleObserver {
...
/**
 * 键盘隐藏
 * @param activity activity Activity引用
 * @param keyboardStateListener 键盘状态回调
 * @return
 */
fun addKeyboardListener(activity: ComponentActivity, keyboardStateListener: KeyboardStateListener): KeyboardHelper {
    return KeyboardHelper(activity = activity, stateListener = keyboardStateListener)
}
