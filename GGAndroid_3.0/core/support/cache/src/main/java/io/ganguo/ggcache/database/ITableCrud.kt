package io.ganguo.ggcache.database
...
interface ITableCrud<T> {
     ...
     * @return Long
     */
    fun insertResultStatus(table: T): Boolean
     ...
     * @return Boolean
     */
    fun updateResultStatus(table: T): Boolean
