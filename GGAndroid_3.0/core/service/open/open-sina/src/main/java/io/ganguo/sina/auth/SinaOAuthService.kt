 ...
 * </pre>
 */
class SinaOAuthService(context: Context, ssoHandler: SsoHandler?, private var callBack: WbAuthListener?) : ASinaOAuthService() {
    private var weakSsoHandler: WeakReference<SsoHandler?> = WeakReference<SsoHandler?>(ssoHandler)
    ...
    override fun startService(): SinaOAuthObservable {
        weakSsoHandler.get()?.authorize(callBack)
