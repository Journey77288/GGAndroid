...
class X5WebApplicationInitializer private constructor() : ApplicationInitializer {
    ...
    companion object : ApplicationInitializerCreator<X5WebApplicationInitializer> {
        /**
         * create ApplicationInitializerCreator
         * @return X5WebApplicationInitializer
         */
        override fun createInitializer(parameter: Map<String, Any>) = X5WebApplicationInitializer()
