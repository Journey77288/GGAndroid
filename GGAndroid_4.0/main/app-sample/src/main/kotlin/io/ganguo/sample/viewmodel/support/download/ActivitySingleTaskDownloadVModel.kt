 ...
 *     author : lucas
 *     time   : 2021/12/27
 *     desc   : Single Task Download Sample ViewModel
 * </pre>
 */
class ActivitySingleTaskDownloadVModel :HFRecyclerVModel<ActivityInterface<FrameHeaderContentFooterBinding>>() {
    companion object {
        const val TEST_URL = "https://static.runoob.com/images/demo/demo2.jpg"
    }
    ...
    override fun initHeader(header: () -> ViewGroup) {
        ...
        HeaderTitleVModel.sampleTitleVModel(viewIF.activity, getString(R.string.str_single_download))
                .let {
    ...
    override fun onViewAttached(view: View) {
        with(adapter) {
            add(ItemDownloadSampleVModel(TEST_URL))
        }
    }
}