...
import io.ganguo.sample.database.table.MyObjectBox
 ...
 * </pre>
 */
class CacheApplicationInitializer private constructor(var debug: Boolean) : ApplicationInitializer {
    ...
    companion object : ApplicationInitializerCreator<CacheApplicationInitializer> {
         ...
         */
        fun create(debug: Boolean): Pair<String, CacheApplicationInitializer> {
            return create(
                    mapOf(
                            KEY_DEBUG to debug
                    )
        ...
        override fun create(): Pair<String, CacheApplicationInitializer> {
            return create(false)
        }
        ...
        override fun createInitializer(parameter: Map<String, Any>): CacheApplicationInitializer {
            ...
            return if (debug == null) {
                ...
                CacheApplicationInitializer(it)
            }
        }
    }
}
