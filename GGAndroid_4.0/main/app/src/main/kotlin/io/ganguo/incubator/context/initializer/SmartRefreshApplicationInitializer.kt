...
class SmartRefreshApplicationInitializer : ApplicationInitializer {
    ...
    override fun initialize(application: Application) {
        SmartRefreshLayout.setDefaultRefreshHeaderCreator { context, _ ->
            ...
            header.setColorSchemeColors(ResourcesHelper.getColor(io.ganguo.resources.R.color.colorPrimaryDark))
            header
        }
        SmartRefreshLayout.setDefaultRefreshFooterCreator { context, layout ->
            layout.setPrimaryColors(ResourcesHelper.getColor(io.ganguo.resources.R.color.colorPrimaryDark))
            layout.setFooterHeightPx(ResourcesHelper.getDimensionPixelOffset(io.ganguo.resources.R.dimen.dp_50))
