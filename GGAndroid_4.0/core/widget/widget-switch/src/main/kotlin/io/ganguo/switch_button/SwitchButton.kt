 ...
 * @property trackOnBgStartColor 开启状态背景渐变开始颜色
 * @property trackOnBgEndColor 开始状态背景渐变结束颜色
...
open class SwitchButton : View {
    ...
    @ColorInt
    var trackOnBgStartColor: Int = Color.GREEN

    @ColorInt
    var trackOnBgEndColor: Int = Color.GREEN
    ...
    private fun initAttributes(attrs: AttributeSet?) {
        ...
        trackOnBgStartColor = array.getColor(R.styleable.SwitchButton_trackOnBgStartColor, trackOnBgStartColor)
        trackOnBgEndColor = array.getColor(R.styleable.SwitchButton_trackOnBgEndColor, trackOnBgEndColor)
    ...
    protected open fun initTrackPaint() {
        ...
        trackOnPaint.shader = LinearGradient(
            0f, 0f, trackWidth.toFloat(), trackHeight.toFloat(), trackOnBgStartColor, trackOnBgEndColor,
