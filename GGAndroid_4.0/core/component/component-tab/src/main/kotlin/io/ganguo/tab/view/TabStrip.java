...
public class TabStrip extends LinearLayout {
    ...
    private TabColorizes mCustomTabColorize;
    ...
    public TabStrip(Context context, float mSelectedIndicatoWidth, float mSelectedIndicatorheight, int marginOffset) {
        this(context, null);
    ...
    protected void onDrawHorizontalIndicator(Canvas canvas) {
        ...
        rectF.left = left + mSelectedIndicatorPadding + marginOffset;
        rectF.top = height - indicatorThickness;
        rectF.right = right - mSelectedIndicatorPadding - marginOffset;
        rectF.bottom = height;
    ...
    public TabColorizes getTabColorizes() {
        TabColorizes colorizes = mCustomTabColorize != null
                ? mCustomTabColorize
    ...
    public void setCustomTabColorizer(TabColorizes customTabColorizer) {
        mCustomTabColorize = customTabColorizer;
        invalidate();
    }
