...
class AliPayOAuthMethod : AAliPayOAuthMethod(), AliPayOAuthListener {
    ...
    override fun oauth(activity: FragmentActivity): AliPayOAuthObservable {
     ...
     */
    override fun newOAuthProvider(activity: FragmentActivity, p: String?): AliPayOAuthProvider {
