...
public abstract class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        this.mSize = context.getResources().getDimensionPixelSize(R.dimen.dp_50);
        this.mBarSize = context.getResources().getDimensionPixelSize(R.dimen.dp_18);
        this.mTopBottomArrowSize = context.getResources().getDimensionPixelSize(R.dimen.dp_11);
        this.mBarThickness = context.getResources().getDimensionPixelSize(R.dimen.dp_2);
        this.mBarGap = context.getResources().getDimensionPixelSize(R.dimen.dp_3);
        this.mMiddleArrowSize = context.getResources().getDimensionPixelSize(R.dimen.dp_16);
