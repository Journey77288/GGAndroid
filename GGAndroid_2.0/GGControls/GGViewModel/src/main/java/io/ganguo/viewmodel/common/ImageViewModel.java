...
public class ImageViewModel extends BaseViewModel<ViewInterface<ItemImageViewModelBinding>> {
    ...
    public static class Builder {
        ...
        public ImageViewModel.Builder width(@DimenRes int width) {
            this.width = width;
            return this;
        }


        public ImageViewModel.Builder height(@DimenRes int height) {
            this.height = height;
            return this;
        }

        public ImageViewModel.Builder marginLeft(@DimenRes int marginLeft) {
            this.marginLeft = marginLeft;
            return this;
        }

        public ImageViewModel.Builder marginTop(@DimenRes int marginTop) {
            this.marginTop = marginTop;
            return this;
        }

        public ImageViewModel.Builder marginRight(@DimenRes int marginRight) {
            this.marginRight = marginRight;
            return this;
        }

        public ImageViewModel.Builder marginBottom(@DimenRes int marginBottom) {
            this.marginBottom = marginBottom;
            return this;
        }

        public ImageViewModel.Builder paddingLeft(@DimenRes int paddingLeft) {
            this.paddingLeft = paddingLeft;
            return this;
        }

        public ImageViewModel.Builder paddingTop(@DimenRes int paddingTop) {
            this.paddingTop = paddingTop;
            return this;
        }

        public ImageViewModel.Builder paddingRight(@DimenRes int paddingRight) {
            this.paddingRight = paddingRight;
            return this;
        }

        public ImageViewModel.Builder paddingBottom(@DimenRes int paddingBottom) {
            this.paddingBottom = paddingBottom;
            return this;
        }

        public ImageViewModel.Builder background(@DrawableRes int background) {
            this.background = background;
            return this;
        }

        public ImageViewModel.Builder src(@DrawableRes int src) {
            this.src = src;
            return this;
        }

        public ImageViewModel.Builder url(String url) {
            this.url = url;
            return this;
        }


        public ImageViewModel.Builder scaleType(ImageView.ScaleType scaleType) {
            this.scaleType = scaleType;
            return this;
        }

        public ImageViewModel.Builder placeHolder(int placeHolder) {
            this.placeHolder = placeHolder;
            return this;
        }

        public ImageViewModel.Builder errorHolder(int errorHolder) {
            this.errorHolder = errorHolder;
            return this;
        }

        public ImageViewModel.Builder errorHolder(String url) {
            this.url = url;
            return this;
        }

        public ImageViewModel.Builder onClickListener(View.OnClickListener onClickListener) {
            this.onClickListener = onClickListener;
            return this;
        }

        public ImageViewModel.Builder visible(boolean visible) {
            this.visible = visible;
            return this;
        }

        public ImageViewModel.Builder clickable(boolean clickable) {
            this.clickable = clickable;
            return this;
        }

        public ImageViewModel.Builder enable(boolean enable) {
