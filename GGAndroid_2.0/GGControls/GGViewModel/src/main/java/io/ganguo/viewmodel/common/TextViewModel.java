...
public class TextViewModel extends BaseViewModel<ViewInterface<ItemTextViewModelBinding>> {
    ...
    public int getTextSize() {
        return getResources().getDimensionPixelSize(builder.textSizeRes);
    }

    @ColorInt
    public int getTextColor() {
        return getResources().getColor(builder.textColorRes);
    }

    @ColorInt
    public int getTextSelectColor() {
        return getResources().getColor(builder.textSelectColorRes);
    }
    ...
    public int getPaddingRight() {
        return getResources().getDimensionPixelSize(builder.paddingRightRes);
    }

    @Dimension
    public int getPaddingTop() {
        return getResources().getDimensionPixelSize(builder.paddingTopRes);
    }

    @Dimension
    public int getPaddingBottom() {
        return getResources().getDimensionPixelSize(builder.paddingBottomRes);
    }

    @Dimension
    public int getMarginLeft() {
        return getResources().getDimensionPixelSize(builder.marginLeftRes);
    }

    @Dimension
    public int getMarginTop() {
        return getResources().getDimensionPixelSize(builder.marginTopRes);
    }

    @Dimension
    public int getMarginRight() {
        return getResources().getDimensionPixelSize(builder.marginRightRes);
    }
    ...
    public int getMarginBottom() {
        return getResources().getDimensionPixelSize(builder.marginBottomRes);
    }

    @Dimension
    public int getDrawablePadding() {
        return getResources().getDimensionPixelSize(builder.drawablePaddingRes);
    }
