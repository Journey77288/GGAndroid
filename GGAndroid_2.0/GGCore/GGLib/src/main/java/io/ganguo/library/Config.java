...
public class Config {
    ...
    public static File getDataPath() {
        return Files.getStorageDirectory(BaseApp.me(), DATA_PATH);
    }
    ...
    public static File getImagePath() {
        return Files.getStorageDirectory(BaseApp.me(), DATA_PATH + File.separator + IMAGES_PATH);
    }
    ...
    public static File getImageCachePath() {
        return Files.getStorageDirectory(BaseApp.me(), DATA_PATH + File.separator + IMAGE_CACHE_PATH);
    }
    ...
    public static File getLogPath() {
        return Files.getStorageDirectory(BaseApp.me(), DATA_PATH + File.separator + APP_LOG_PATH);
    }
    ...
    public static File getTempPath() {
        return Files.getStorageDirectory(BaseApp.me(), DATA_PATH + File.separator + APP_TEMP_PATH);
    }
    ...
    public static void clearData() {
        File cacheFile = BaseApp.me().getCacheDir();
        if (cacheFile != null) {
