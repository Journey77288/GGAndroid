...
public final class Colors {
     ...
     * 计算渐变颜色
     *
     * @param expandedColor 展开时颜色
     * @param foldedColor   折叠时颜色
     * @return
     */
    public static int evaluatorViewColor(float factor, int expandedColor, int foldedColor) {
        int color = (int) getEvaluator().evaluate(factor, expandedColor, foldedColor);
        return color;
    }
     ...
     * @return
     */
    public static ArgbEvaluator getEvaluator() {
        if (evaluator == null) {
