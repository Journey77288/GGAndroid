...
public class ViewAnimations {
    ...
    public static void invisibleViewByAlpha(final View view,
        ...
        if (view.getVisibility() != View.INVISIBLE) {
            ...
            AlphaAnimation hiddenAlphaAnimation = Animations.getHiddenAlphaAnimation(durationMillis);
    ...
    public static void invisibleViewByAlpha(final View view,
        ...
        invisibleViewByAlpha(view, Animations.DEFAULT_ANIMATION_DURATION,
    ...
    public static void goneViewByAlpha(final View view, long durationMillis,
        ...
        if (view.getVisibility() != View.GONE) {
            ...
            AlphaAnimation hiddenAlphaAnimation = Animations
    ...
    public static void goneViewByAlpha(final View view,
                                       final boolean isBanClick, final AnimationListener animationListener) {
        goneViewByAlpha(view, Animations.DEFAULT_ANIMATION_DURATION,
                isBanClick, animationListener);
    }
    ...
    public static void goneViewByAlpha(final View view,
                                       final AnimationListener animationListener) {
        goneViewByAlpha(view, Animations.DEFAULT_ANIMATION_DURATION, false,
                animationListener);
    }
    ...
    public static void visibleViewByAlpha(final View view, long durationMillis,
        ...
        if (view.getVisibility() != View.VISIBLE) {
            ...
            AlphaAnimation showAlphaAnimation = Animations
    ...
    public static void visibleViewByAlpha(final View view,
                                          final boolean isBanClick, final AnimationListener animationListener) {
        visibleViewByAlpha(view, Animations.DEFAULT_ANIMATION_DURATION,
                isBanClick, animationListener);
    }
