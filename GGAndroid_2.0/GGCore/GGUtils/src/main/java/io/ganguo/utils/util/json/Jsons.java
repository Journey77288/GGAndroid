...
public class Jsons {
     ...
     * <li>return {@link Jsons#getLong(JSONObject, String, Long)}</li>
     * </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see Jsons#getLong(JSONObject, String, Long)
     */
    public static long getLong(JSONObject jsonObject, String key, long defaultValue) {
     ...
     * @param defaultValue
     * @return
     * @see Jsons#getLong(String, String, Long)
     */
    public static long getLong(String jsonData, String key, long defaultValue) {
     ...
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link Jsons#getInt(JSONObject, String, Integer)}</li>
     * </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see Jsons#getInt(JSONObject, String, Integer)
     */
     ...
     * @param defaultValue
     * @return
     * @see Jsons#getInt(String, String, Integer)
     */
     ...
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link Jsons#getDouble(JSONObject, String, Double)}</li>
     * </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see Jsons#getDouble(JSONObject, String, Double)
     */
    public static double getDouble(JSONObject jsonObject, String key, double defaultValue) {
     ...
     * @param defaultValue
     * @return
     * @see Jsons#getDouble(String, String, Double)
     */
    public static double getDouble(String jsonData, String key, double defaultValue) {
     ...
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link Jsons#getString(JSONObject, String, String)}</li>
     * </ul>
     */
     ...
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link Jsons#getStringArray(JSONObject, String, String[])}</li>
     * </ul>
     */
     ...
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link Jsons#getStringList(JSONObject, String, List)}</li>
     * </ul>
     */
     ...
     * <li>if jsonData is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link Jsons#getJSONObject(JSONObject, String, JSONObject)}</li>
     * </ul>
     */
     ...
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link Jsons#getJSONArray(JSONObject, String, JSONObject)}</li>
     * </ul>
     */
     ...
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link Jsons#getBoolean(JSONObject, String, Boolean)}</li>
     * </ul>
     */
     ...
     * <li>return {@link Jsons#parseKeyAndValueToMap(String)}</li>
     * </ul>
     */
    public static Map<String, String> getMap(JSONObject jsonObject, String key) {
        return Jsons.parseKeyAndValueToMap(Jsons.getString(jsonObject, key, null));
    }
     ...
     * <li>return {@link Jsons#getMap(JSONObject, String)}</li>
     * </ul>
     */
     ...
     * <li>return {@link Jsons#parseKeyAndValueToMap(JSONObject)}</li>
     * </ul>
     */
    ...
    public static boolean containsKey(String jsonData, String key) {
        if (Strings.isEmpty(jsonData)) {
            return false;
        }
        ...
        try {
            JSONObject jsonObject = new JSONObject(jsonData);
            return containsKey(jsonObject, key);
        } catch (JSONException e) {
            if (isPrintException) {
                e.printStackTrace();
            }
